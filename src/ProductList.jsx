...
function ProductList({ onHomeClick }) {
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        // Ensure we are in the products view
        setShowCart(false);
    };
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div style={{ position: 'relative' }}> 
                        ...
                        {totalCartQuantity() > 0 && (
                            <span className='cart_quantity_count' aria-label='cart-quantity'>
                                {totalCartQuantity()}
                            </span>
                        )}
                    </div>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <div className="product-description" style={{ fontStyle: 'italic', color: '#555' }}>{plant.description}</div>
                                        <div className="product-cost" style={{ color: '#e74c3c', fontWeight: 'bold' }}>{plant.cost}</div>
                                        <button
